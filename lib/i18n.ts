...
const translations: Record<string, Translations> = {
  en: {
    ...
    heroTitle: "Explore Tivat on Two Wheels",
    ...
    feature1Description:
      "Go wherever you want, whenever you want. Discover hidden beaches and scenic viewpoints at your own pace.",
    ...
    feature3Description:
      "Access the best local spots that larger vehicles can't reach. Park easily and enjoy more of Tivat.",
    ...
    feature5Description:
      "Our team is always available to help with any questions or assistance you might need during your rental.",
    ...
    website: "Website",
    footerDescription:
      "Rent a scooter and explore the beautiful Montenegrin coast at your own pace. Experience freedom, adventure, and unforgettable memories.",
  ...
  sr: {
    ...
    heroTitle: "Istražite Tivat na dva točka",
    ...
    experienceDescription:
      "Otkrijte radost istraživanja Tivta i njegove okoline na našim modernim, pouzdanim skuterima.",
    feature1Title: "Sloboda istraživanja",
    feature1Description:
      "Idite gde god želite, kad god želite. Otkrijte skrivene plaže i panoramske vidikovce svojim tempom.",
    ...
    feature3Description:
      "Pristupite najboljim lokalnim mestima do kojih veća vozila ne mogu doći. Parkirajte se lako i uživajte više u Tivtu.",
    ...
    feature5Description:
      "Naš tim je uvek dostupan da pomogne sa bilo kojim pitanjima ili pomoći koja vam može zatrebati tokom iznajmljivanja.",
    ...
    footerDescription:
      "Iznajmite skuter i istražite prelepu crnogorsku obalu svojim tempom. Doživite slobodu, avanturu i nezaboravne uspomene.",
  ...
  ru: {
    ...
    heroTitle: "Исследуйте Тиват на двух колесах",
    ...
    experienceDescription:
      "Откройте для себя радость исследования Тивата и его окрестностей на наших современных, надежных скутерах.",
    feature1Title: "Свобода исследования",
    feature1Description:
      "Отправляйтесь куда хотите и когда хотите. Откройте для себя скрытые пляжи и живописные смотровые площадки в своем темпе.",
    ...
    feature3Description:
      "Получите доступ к лучшим местным местам, куда не могут добраться более крупные транспортные средства. Легко паркуйтесь и наслаждайтесь Тиватом.",
    ...
    feature5Description:
      "Наша команда всегда доступна, чтобы помочь с любыми вопросами или помощью, которая может вам понадобиться во время аренды.",
    ...
    website: "Веб-сайт",
    footerDescription:
      "Арендуйте скутер и исследуйте прекрасное черногорское побережье в своем темпе. Испытайте свободу, приключения и незабываемые воспоминания.",
  ...
  he: {
    ...
    heroTitle: "גלו את טיבאט על שני גלגלים",
    heroSubtitle: "חוו את החופש של חוף מונטנגרו עם הקטנועים האיכותיים שלנו להשכרה",
    rentNow: "השכר עכשיו",
    ...
    experienceTitle: "חוו את ההרפתקה",
    experienceDescription: "גלו את השמחה של חקר טיבאט וסביבתה על הקטנועים המודרניים והאמינים שלנו.",
    feature1Title: "חופש לחקור",
    feature1Description: "לכו לאן שתרצו, מתי שתרצו. גלו חופים נסתרים ונקודות תצפית נופיות בקצב שלכם.",
    feature2Title: "שמש ורוח ים",
    feature2Description: "הרגישו את הרוח הים התיכונית בעת שיוט לאורך חוף האדריאטי היפה.",
    feature3Title: "נקודות חמות מקומיות",
    feature3Description:
      "גישה למקומות המקומיים הטובים ביותר שכלי רכב גדולים יותר לא יכולים להגיע אליהם. חנו בקלות ותיהנו יותר מטיבאט.",
    ...
    feature5Description: "הצוות שלנו תמיד זמין לעזור בכל שאלה או סיוע שאתם עשויים להזדקק במהלך ההשכרה.",
    readyToRide: "מוכנים לרכוב?",
    readyToRideDescription: "הזמינו את הקטנוע שלכם עכשיו והתחילו את הרפתקת טיבאט שלכם היום!",
    bookNow: "הזמן עכשיו",
  ...
  fr: {
    ...
    heroTitle: "Explorez Tivat sur deux roues",
